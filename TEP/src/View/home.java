...
public class home extends javax.swing.JFrame {
    ...
    public home(String amka_login, Controller cont) throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton6.setText("SubmitSymptoms");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            this.cont.takeExaminationFromDoctor(Integer.parseInt(amka_login));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            this.cont.takeExaminationFromNurse(Integer.parseInt(amka_login));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            this.cont.takeReExaminationFromDoctor(Integer.parseInt(amka_login));
            this.jButton4.setEnabled(false);
            this.jButton2.setEnabled(false);
        } catch (SQLException ex) {
            Logger.getLogger(home.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        this.cont.setSymptoms(this.jTextField1.getText());
